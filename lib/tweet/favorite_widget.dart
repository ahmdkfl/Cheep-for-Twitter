...
class _FavoriteWidgetState extends State<FavoriteWidget> {
  ...
  Future<dynamic> _favoriteTweet() async {
    ...
    // Pass the id of the tweet to favorite
    body['id'] = widget.id;
    return await client
        .post('https://api.twitter.com/1.1/favorites/create.json', body: body);
  }
  ...
  Future<dynamic> _unfavoriteTweet() async {
    var client = Twitterapi().getClient();
    Map<String, String> body = new Map();
    // Pass the id of the tweet to unfavorite
    body['id'] = widget.id;
    return await client
        .post('https://api.twitter.com/1.1/favorites/destroy.json', body: body);
  }
}
